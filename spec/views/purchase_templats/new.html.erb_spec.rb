...
describe "purchase_templats/new" do
  before(:each) do
    assign(:purchase_templat, stub_model(PurchaseTemplat,
      :Rails => "MyString",
      :g => "MyString",
      :scaffold => "MyString",
      :Ps => "MyString",
  ...
  it "renders new purchase_templat form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => purchase_templats_path, :method => "post" do
