...
describe "cheque_payments/edit" do
  before(:each) do
  ...
  it "renders the edit cheque_payment form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => cheque_payments_path(@cheque_payment), :method => "post" do
