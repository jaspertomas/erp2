...
describe "stock_entries/new" do
  before(:each) do
    assign(:stock_entry, stub_model(StockEntry,
      :qty => "9.99",
      :balance => "9.99",
      :stock_id => 1,
      :ref_class => "MyString",
  ...
  it "renders new stock_entry form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => stock_entries_path, :method => "post" do
