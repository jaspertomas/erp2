...
describe "purchases/new" do
  ...
  it "renders new purchase form" do
    ...
    assert_select "form", :action => purchases_path, :method => "post" do
      ...
      assert_select "input#purchase_template_id", :name => "purchase[template_id]"
      assert_select "input#purchase_vendor_invoice", :name => "purchase[vendor_invoice]"
      assert_select "input#purchase_discrate", :name => "purchase[discrate]"
